...
var rule = {
    ...
    `,
	 lazy: `js:
        ...
        let url = parseDom(html, 'img&&data-src') || parseDom(html, 'img&&src');
        input = { 
            parse: 0, 
            url: url,
            header: {  // 图片请求必须携带的来源头
                'Referer': 'https://v.aikanbot.com/',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/'
